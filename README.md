...
Write a program that prints the alphabet in lowercase, and then in uppercase, followed by a new line.</br></br>
...
Write a program that prints all possible combinations of single-digit numbers.</br></br>
